...
public class StaticDemo {
	public static void main(String[] args) {
		...
		// StaticMethod.metNormal(); - this is not possible, because metNormal method is
...
class StaticMethod {
	int money;	// this variable will be loaded in memory only when the object of this class is
				// created
	// the above variable cannot be accessed by a static method, because static
	// methods are already in memory
