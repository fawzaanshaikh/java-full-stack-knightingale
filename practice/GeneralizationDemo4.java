...
abstract class A {
	...
	// when you declare a abstract method, then the class should be compulsorily
	// declared
	// as abstract, and abstract methods have to compulsorily overridden in the sub
	// class
...
class B extends A {
	...
	// since met method is already declared in parent class, this is called
	// overriding
